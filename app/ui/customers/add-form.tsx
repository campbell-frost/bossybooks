...
<form className="w-full max-w-lg">
    ...
    <div className="w-full md:w-1/2 px-3 md:mb-0">
      ...
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none  focus:border-bg-pink-600" id="grid-last-name" type="text" placeholder="Enter last name"/>
    </div>
  </div>
